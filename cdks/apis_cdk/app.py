...
env_us_east_1 = Environment(account="047988295961", region="us-east-1")
...
env = Environment(account="047988295961", region="us-east-2")

# Create the API Gateway stack
MyApiGatewayStack(app, "MyApiStack", cross_region_references=True, certificate_stack=cert_stack, env=env)
